...
class FirebaseServices extends GetxController {
  ...
  Future<void> registration({
    ...
    try {
      ...
      Get.snackbar("Verify Email".tr, "A verification email has been sent. Please check your inbox.".tr);

      // 👇 Go to a special screen telling user to verify
      Get.offAllNamed(RoutesName.emailVerification);
  ...
  Future<void> login({required String email, required String password}) async {
    ...
    try {
      ...
      if (user != null && !user.emailVerified) {
        ...
        // Show message
        Get.snackbar("Email Not Verified".tr, "Please verify your email first.".tr);

        // Move user to verification screen
